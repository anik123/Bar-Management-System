            ...
            <div class="Singel_Search_Main">
                <div align="center">
                    ...
                    <tr>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label9" runat="server" CssClass="clabel_Location" >Company Name:</asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlCName" runat="server" CssClass="DDL_2_div" 
                                        AutoPostBack="True">
                                    </asp:DropDownList>
                                  </td>
                            </tr>
                ...
                <asp:GridView ID="GvUpdate" runat="server" BackColor="#92B8EF" ForeColor="Snow" BorderColor="#92B8EF"
                    ...
                    <Columns>
                      ...
                      <%--  <asp:TemplateField HeaderText="Sale Price">
                            <ItemTemplate>
                                <asp:TextBox ID="txtSalePrice" Width="100px" Text='<%#Eval("ProductSalePrice") %>'
                                    runat="server"></asp:TextBox>
                                <ajaxtoolkit:FilteredTextBoxExtender ID="ftsaleprice" runat="server" TargetControlID="txtSalePrice"
