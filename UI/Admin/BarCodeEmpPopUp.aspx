            ...
            <asp:Panel ID="panel_PopupInpatient" runat="server" CssClass="ModalPopup" Width="580px">
                ...
                <div>
                    <table style="width: 100%;">
                        ...
                        <tr>
                        <td>
                                       <asp:Label ID="Label2" runat="server" CssClass="clabel_EmpPopup" Text="Price:"></asp:Label>
                 
                        </td>
                        <td>
                            <asp:TextBox ID="txtPrice" runat="server" CssClass="input_textcss_empPopupBarcode" AutoPostBack="True"></asp:TextBox>
                            
                        </td>
                        <td>
                                       <asp:Label ID="Label9" runat="server" CssClass="clabel_EmpPopup" Text="Product Code:"></asp:Label>
                 
                        </td>
                        <td>
                            <asp:TextBox ID="txtProductCode" runat="server" CssClass="input_textcss_empPopupBarcode" AutoPostBack="True"></asp:TextBox>
