        ...
        <ContentTemplate>
            <div class="CompMain">
                ...
                <div class="Singlelebel_Child">
                    <asp:Label ID="Label5" runat="server" Text="Branch Info Entry" ></asp:Label>
                </div>
                <div class="clear"></div>
            ...
            <div class="Singlelebel_Child">
                <asp:Label ID="Label21" runat="server" Text="Search Branch" ></asp:Label>
            </div>
            <div class="clear"></div>
                                ...
                                <FooterTemplate>
                                    <tr style="background-color: #8FADD9">
                                        <td colspan="5" align="center">
                                            <asp:Label ID="Label1" runat="server" Text="Branch Info..." ForeColor="White"></asp:Label>
                                        </td>
                                    </tr>
                                    </table>
                                </FooterTemplate>
