<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProductChange.aspx.cs" Inherits="UI.Shop.ProductChange" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="PnlChangelist" Visible="false" runat="server">
                <div>
                    <asp:Label ID="Label17" runat="server" Text=" Product Change Panel" CssClass="Font_header"></asp:Label>
                </div>
                <div>
                    <%-- OnSelectedIndexChanged="GvUpdate_SelectedIndexChanged"--%>
                    <asp:GridView ID="GvUpdate" runat="server" BackColor="#92B8EF" ForeColor="Snow" BorderColor="#92B8EF"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Quantity">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtQuantity" Width="50px" AutoPostBack="true" OnTextChanged="txtQuantity_TextChanged"
                                        Text='<%#Eval("Quantity") %>' runat="server"></asp:TextBox>
                                    <ajaxtoolkit:FilteredTextBoxExtender ID="ftxtrate" runat="server" TargetControlID="txtQuantity"
                                        FilterType="Custom, Numbers" ValidChars="" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Change Status">
                                <ItemTemplate>
                                    <asp:RadioButton ID="RbtCustomerRequirment" GroupName="ChangeGroup"  runat="server" Text="Customer Requirement" />
                                    <asp:RadioButton ID="RbtRejection" runat="server" GroupName="ChangeGroup" Text="Rejection" />
                                </ItemTemplate>
                            </asp:TemplateField>
            ...
            <div>
                <asp:Label ID="Label15" runat="server" Text="Sales Product  Panel" CssClass="Font_header"></asp:Label>
            </div>
                    ...
                    <asp:Panel ID="PnlExSerch_new" CssClass="IndorpatientPayment_main" runat="server">
                        <asp:Panel ID="pnlCash" runat="server" CssClass="IndorpatientPayment_left">
                            <table style="width: 100%;">
                                <tr>
                                    <td>
                                        <asp:Label ID="Label16" CssClass="clabel" runat="server" Text="Change Amount"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTtoatalChangeAmount" runat="server" Width="116px" AutoPostBack="true"
                                            CssClass="input_textcss"></asp:TextBox>
                                        <asp:Button ID="btnTotalChangeCalculation" runat="server" Text="Change Tk" Height="22px"
                                            Width="78" OnClick="btnTotalChangeCalculation_Click" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="Label31" runat="server" Text="Total Sales Price:" CssClass="clabel"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtCustomerPayable" runat="server" Width="196px" AutoPostBack="true"
                                            CssClass="input_textcss"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label7" runat="server" Text="Customer Payble:" CssClass="clabel"></asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ajaxtoolkit:FilteredTextBoxExtender ID="filtervatparcen" runat="server" TargetControlID="txtVatPercentage"
                                            FilterType="Custom, Numbers" ValidChars="." />
                                        <asp:TextBox ID="txtVatAfterpercentage" runat="server" Width="56px" CssClass="input_textcss">0</asp:TextBox><span
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        ...
                                        <ajaxtoolkit:FilteredTextBoxExtender ID="fd" runat="server" TargetControlID="txtDicountpercentage"
                                            FilterType="Custom, Numbers" ValidChars="." />
                                        <asp:TextBox ID="txtDicountAfterpercentage" runat="server" Width="56px" CssClass="input_textcss">0</asp:TextBox><span
                                            style="vertical-align: top;">tk</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNetTotalPayable" Text="0" runat="server" Width="196px" ReadOnly="true"
                                            CssClass="input_textcss"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
