    ...
    <table id="tableMain" class="ReportViewHR">
      <%-- 
        ...
        <tr>
            ...
            <td align="left">
                <asp:Button ID="btnStockDetails" runat="server" CssClass="AccRptUiBtn" Style="float: none;"
                    Text="Branch Stock Details" OnClientClick="NewWindow();" 
                    onclick="btnStockDetails_Click" />
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td align="left">
                <asp:Button ID="ButtonProfit" runat="server" CssClass="AccRptUiBtn" Style="float: none;"
                    Text="Shop Profit Report" OnClientClick="NewWindow();" 
                    onclick="ButtonProfit_Click"  />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td align="left">
                <asp:Button ID="btnShopReturnRptView" runat="server" CssClass="AccRptUiBtn" Style="float: none;"
                    Text="Shop Return View " OnClientClick="NewWindow();" OnClick="btnShopReturnRptView_Click" />
            </td>
        </tr>
         <tr>
            <td>
            ...
            <td align="left">
                <asp:Button ID="ButtonReturn" runat="server" CssClass="AccRptUiBtn"
                    Style="float: none;" Text="Branch Return  Report " 
                    OnClientClick="NewWindow();" onclick="ButtonReturn_Click"  />
            </td>
        </tr>
        --%>
        <tr>
