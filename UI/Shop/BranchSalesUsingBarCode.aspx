<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="BranchSalesUsingBarCode.aspx.cs" Inherits="UI.Shop.BranchSalesUsingBarCode" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rvcon" ValidationGroup="vg4" runat="server" ForeColor="Red"
            ...
            <asp:Panel ID="pnlUpdate" runat="server">
                <asp:Label ID="Label7" runat="server" CssClass="Font_header" Text="Product Entry"></asp:Label><asp:TextBox
                    ID="txtProductId" Width="80px" runat="server"></asp:TextBox><asp:Button ID="btnProduct"
                        runat="server" Text="Product Click" OnClick="btnProduct_Click" />&nbsp;&nbsp;&nbsp;<asp:Label 
                    ID="lblProductSts" runat="server" ForeColor="Red"></asp:Label>
                <br>
                <div class="InvenPur_main">
                    <div class="InvenPur_left">
                        <table style="width: 100%;">
                            <tr>
                                <td>
                                    <asp:Label ID="Label9" runat="server" CssClass="clabel_Location" 
                                        Text="Company Name:"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlCName" runat="server" AutoPostBack="True" 
                                        CssClass="input_textcss" Width="202px">
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RFv" runat="server" 
                                        ControlToValidate="ddlCName" ForeColor="Red" ValidationGroup="vg4">Se555lect</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label3" runat="server" CssClass="clabel_Location" 
                                        Text="Product:"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlCateName" runat="server" CssClass="input_textcss" 
                                        OnSelectedIndexChanged="ddlCateName_SelectedIndexChanged" Width="202px">
                                    </asp:DropDownList>
                                    <%--  <span class="Mandatory">*</span>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lcomp" runat="server" CssClass="clabel_Location" 
                                        Text="Product Code:"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlPName" runat="server" CssClass="input_textcss" 
                                        Width="202px">
                                    </asp:DropDownList>
                                    <%--   <span class="Mandatory">*</span>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label4" runat="server" CssClass="clabel_Location" Text="Unit:"></asp:Label>
                                </td>
                                <td>
                    ...
                    <div class="InvenPur_right">
                        <table style="width: 100%;">
                            <tr>
                                <td>
                                    <asp:Label ID="Label5" runat="server" CssClass="clabel_Location" 
                                        Text="Current Quantity:"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtCurrent" runat="server" CssClass="input_textcss" 
                                        ReadOnly="true" Text="0" Width="200px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="LabelMobile1" runat="server" CssClass="clabel_Location" 
                                        Text=" Purchase Quantity:"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtPQuality" runat="server" CssClass="input_textcss" 
                                        Width="200px"></asp:TextBox>
                                    <span class="Mandatory">*</span>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                        ControlToValidate="txtPQuality" ForeColor="Red" ValidationGroup="vg1">Empty</asp:RequiredFieldValidator>
                                    <ajaxtoolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" 
                                        runat="server" FilterType="Custom, Numbers" TargetControlID="txtPQuality" 
                                        ValidChars="" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label1" runat="server" CssClass="clabel_Location" 
                                        Text="Unit Price:"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtPurPrice" runat="server" CssClass="input_textcss" 
                                        ReadOnly="true" Width="200px"></asp:TextBox>
                                    <span class="Mandatory">*</span>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                        ControlToValidate="txtPurPrice" ForeColor="Red" ValidationGroup="vg1">Empty</asp:RequiredFieldValidator>
                                    <ajaxtoolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" 
                                        runat="server" FilterType="Custom, Numbers" TargetControlID="txtPurPrice" 
                                        ValidChars="." />
                                </td>
                            </tr>
                        </table>
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="btnAdd" runat="server" CausesValidation="true" 
                                    CssClass="Add_Short" OnClick="btnAdd_Click" Text="ADD" ValidationGroup="vg1" />
                            </td>
                            <td>
                                <asp:Button ID="btnCancel" runat="server" CausesValidation="false" 
                                    CssClass="Clear_Short" OnClick="btnCancel_Click" Text="Clear" />
                            </td>
                        </tr>
                    </table>
                </div>
