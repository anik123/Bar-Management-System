...
namespace UI.Shop
{
    public partial class BranchToCenteralReturnUI : System.Web.UI.Page
    {
        ...
        InvenBranchToCentralReturnDtlBLL CenPartyBLL = new InvenBranchToCentralReturnDtlBLL();
        InvenBranchToCentralReturnDtlDto CenPartyDto = new InvenBranchToCentralReturnDtlDto();
        ...
        public void LoadProductGridView()
        {
            ...
            var pp = PBLL.GetProductForReturn(Convert.ToInt16(ddlCName.SelectedValue), Convert.ToInt16(ddlCateName.SelectedValue), Convert.ToInt16(ddlPName.SelectedValue));
                if (pp.Count != 0)
                {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (ddlCName.SelectedIndex == -1 || ddlCName.SelectedIndex == 0)
            {
                        ...
                        if (txtreturn.Text != "" && row.Cells[5].Text != "")
                        {
                            ...
                            else
                            {
                                ...
                                if (inStoreSts.Count() > 0)
                                {
                                    ...
                                    CNStoreDTO.QuantityStore = int.Parse(txtreturn.Text) + cnQnty;
                                    ...
                                    CenPartyDto.reProAmount = int.Parse(row.Cells[4].Text) * int.Parse(txtreturn.Text);
                                    CenPartyDto.reProBranchId = int.Parse(HFBranceId.Value);
                                    ...
                                    BrStoreBLL.EditQty(BrStoreDTO);
                                    CNStoreBLL.EditQty(CNStoreDTO);
                                    SearchClearControl();
