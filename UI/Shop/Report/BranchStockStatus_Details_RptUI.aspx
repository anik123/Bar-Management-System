<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BranchStockStatus_Details_RptUI.aspx.cs"
    Inherits="UI.Shop.Report.BranchStockStatus_Details_RptUI" %>
        ...
        <ContentTemplate>
            ...
            <div style="margin-top: 10px;">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                    ...
                    <LocalReport ReportPath="Shop\Report\DetailsBranchStoreStatusRpt.rdlc">
                        <DataSources>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="BranchStockStatus_Details_Rpt"
