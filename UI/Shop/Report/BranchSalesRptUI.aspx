...
<center>
    ...
    <div style="clear: both; margin: 10px 0px 0px 0px;font-size:6px;">
        <rsweb:ReportViewer ID="ReportViewer1" CssClass="font" runat="server" Height="400px" 
            Width="100%" Font-Names="Verdana" Font-Size="6pt" 
            InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana" 
            WaitMessageFont-Size="6pt">
