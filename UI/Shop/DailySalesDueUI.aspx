<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DailySalesDueUI.aspx.cs" Inherits="UI.Shop.DailySalesDueUI" %>
            ...
            <div class="mainheadpage">
                <table style="margin-left: 235px; margin-top: 20px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtBarBill" ReadOnly="true" Text="0" CssClass="SingleDropDownList"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtRestuarentBill" Text="0" ReadOnly="true" CssClass="SingleDropDownList"
                                runat="server"></asp:TextBox>
                            <span class="Mandatory">*</span>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtCateringBill" Text="0" ReadOnly="true" CssClass="SingleDropDownList"
                                runat="server"></asp:TextBox>
                            <span class="Mandatory">*</span>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtBekaryBill" Text="0" ReadOnly="true" CssClass="SingleDropDownList"
                                runat="server"></asp:TextBox>
                            <span class="Mandatory">*</span>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtGuestChargeBill" Text="0" ReadOnly="true" CssClass="SingleDropDownList"
                                runat="server"></asp:TextBox>
                            <span class="Mandatory">*</span>
