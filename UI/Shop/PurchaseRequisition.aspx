<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PurchaseRequisition.aspx.cs" Inherits="UI.Shop.PurchaseRequisition" %>
        ...
        <ContentTemplate>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlCategory" CssClass="input_textcss" runat="server" Width="202px">
                        </asp:DropDownList>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlCompany" runat="server" CssClass="input_textcss" Width="202px">
                        </asp:DropDownList>
            ...
            <asp:GridView ID="GvUpdate" runat="server" BackColor="#92B8EF" ForeColor="Snow" BorderColor="#92B8EF"
                ...
                PageSize="10" DataKeyNames="ProductId" OnPageIndexChanging="GvUpdate_PageIndexChanging"
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="Mandatory">*</span><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="vg1"
                                        ForeColor="Red" ControlToValidate="txtPQuality">Empty</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="Label6" runat="server" CssClass="clabel_Location" 
                                        Text="Purchase Price Per Unit:"></asp:Label>
                                </td>
                                <td>
