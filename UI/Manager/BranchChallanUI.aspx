        ...
        <ContentTemplate>
                ...
                <div class="PharmProPur">
                    ...
                    <asp:GridView ID="GVCOA" runat="server" BackColor="#92B8EF" ForeColor="Snow" BorderColor="#92B8EF"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ReqPurOrderId" HeaderText=" Requisition Purchase Order ID" />
                        </Columns>
                    </asp:GridView>
                </div>
            </asp:Panel>
            <asp:Panel ID="PnlInfoProduct" Visible="false" runat="server">
                ...
                <span style="padding-left: 20px;">
                    <asp:Button ID="btnPost" runat="server" Width="122px" CausesValidation="false" Height="22px"
                        Text="Post To Branch" OnClick="btnPost_Click" />
                </span>
            ...
            <asp:Panel ID="pnlAction" Visible="false" runat="server">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTotalPayable" ReadOnly="true" ForeColor="Red" AutoPostBack="true"
                                        CssClass="input_textcss" runat="server" Width="120px" Text="0"></asp:TextBox>
                                    <asp:Button ID="btnTotalAmount" runat="server" Text="Adjust Amount" OnClick="btnTotalAmount_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                ...
                <table style="width: 100%;">
                    ...
                    <ajaxtoolkit:ModalPopupExtender ID="modalPopup" runat="server" DropShadow="false"
                        BackgroundCssClass="modalPopup" RepositionMode="RepositionOnWindowResizeAndScroll"
                        TargetControlID="UpdateProgress" PopupControlID="UpdateProgress" />
                </table>
