<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CentralAllPurchaseView.aspx.cs" Inherits="UI.Manager.CentralAllPurchaseView" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="Singlelebel_Child">
                <asp:Label ID="Label14" runat="server"  Text="Search For Payment"></asp:Label>
                </div>
                <div class="clear"></div>
            ...
            <asp:Panel ID="pnlRec" runat="server">
                ...
                <div class="Singlelebel_Child">
                    <asp:Label ID="Label1" runat="server" Text="List of Purchase Form Differenct Company"></asp:Label>
                    </div>
                    <div class="clear"></div>
                    <asp:GridView ID="GvDueInfo" runat="server" BackColor="White" BorderColor="White"
                        ...
                        OnPageIndexChanging="GvDueInfo_PageIndexChanging" DataKeyNames="PurId" PageSize="15">
