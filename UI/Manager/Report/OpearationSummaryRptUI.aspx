<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpearationSummaryRptUI.aspx.cs"
    Inherits="UI.Manager.Report.OpearationSummaryRptUI" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            ...
            <div style=" margin-top: 10px;">
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="PurchaseOperationSummary"
