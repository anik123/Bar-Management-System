...
namespace UI.Manager
{
    public partial class PurchasePaymentDueUI : System.Web.UI.Page
    {
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            // add  pur due amount payment using journal Head
            // var trandata = TranBLL.LoadTransDetailsData_DR(6);// purchase transection Item
            JDTO.JournalType = "CR";
            JDTO.COAId = 45;
            JDTO.SubCode2Id = 38;
            JDTO.SubVoucherId = 3;//trandata.First().DrSubVoucherId;
            JDTO.DRAmount = null;//
            ...
            var dueamount = JBLL.LoadJournalUpdate_Purchase_DuePayment(42, 20, "PurDue" + "-" + HFPurId.Value);
           // JDTO.JournalType = "CR";
           // JDTO.COAId = 42;
           // JDTO.SubCode2Id = 20;
           // JDTO.SubVoucherId = 3;
          //  JDTO.DRAmount = null;
            JDTO.JournalId = dueamount.First().JournalId;
            JDTO.CRAmount = dueamount .First().CRAmount- Convert.ToDouble(txtPaidAmoun.Text);

            JDTO.CreateBy = HttpContext.Current.User.Identity.Name;// HttpContext.Current.User.Identity.Name;
            JDTO.CreateDate = System.DateTime.Now;
            JBLL.Edit_Journal_Due_Payment(JDTO);
