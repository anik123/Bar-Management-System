<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PurchaseOrderCentrealUI.aspx.cs" Inherits="UI.Manager.PurchaseOrderCentrealUI" %>
        ...
        <ContentTemplate>
                            ...
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" CssClass="RequiredFieldcss"
            ...
            <asp:Panel ID="PnlLoadRequsionDatalist" Visible="false" runat="server">
                <asp:Label ID="Label2" runat="server" CssClass="Font_header" Text="Requisition Product List"></asp:Label><span
                    style="padding-left: 20px;"><asp:Button ID="btnPost" runat="server" CausesValidation="false"
                        Width="122px" Height="22px" Text="Post To Order" OnClick="btnPost_Click" /></span>
            ...
            <asp:Panel ID="pnlAction" Visible="false" runat="server">
                ...
                <div class="total_payable_main">
                    <div class="total_payable_left">
                        <table style="width: 100%;">
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTotalPayable" ReadOnly="true" ForeColor="Red" AutoPostBack="true"
                                        CssClass="input_textcss" runat="server" Text="0"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
