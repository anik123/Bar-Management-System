<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="IncomeStatementRptUI.aspx.cs" Inherits="UI.AccSysManagment.Report_Setup_File.IncomeStatementRptUI" %>
    ...
    <asp:UpdatePanel ID="upid" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="mainheadpage">
                <div>
                    <asp:Label ID="Label2" runat="server" Text="Income Statement Report Setup" CssClass="Font_header"></asp:Label>
                </div>
            ...
            <div>
                <table style="width: 100%;">
                    <tr>
                        <td>
                            <asp:Label ID="Label11" runat="server" Text="Income Statement Report Setup List"
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="GVCFR" runat="server" BackColor="#92B8EF" ForeColor="Snow" BorderColor="#92B8EF"
                                ...
                                Width="100%" PageSize="8" DataKeyNames="InStaRptId" OnPageIndexChanging="GVCFR_PageIndexChanging"
