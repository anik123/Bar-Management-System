...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel runat="server" ID="UpdatePanel2">
        <ContentTemplate>
            <ajaxtoolkit:TabContainer runat="server" ID="Tab" ActiveTabIndex="2" 
                Width="100%">
                <ajaxtoolkit:TabPanel runat="server" ID="TabPanel3" HeaderText="Department Setup">
                    <ContentTemplate>
                        <div class="Header_Page">
                            <div class="middle">
                                <div class="Singlelebel_Child">
                                    <asp:Label ID="Label5" runat="server" Text=" Department Entry"></asp:Label></div>
                            </div>
                        </div>
                        <div class="Emptype">
                        ...
                        <div>
                            <div class="Singlelebel_Child">
                            <asp:Label ID="Label3" runat="server" Text="Department List"></asp:Label>
                            </div>
                            <div class="clear"></div>
                            <asp:GridView
                    ...
                    <ContentTemplate>
                        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                            <ContentTemplate>
                                <div class="middle">
                                <div class="Singlelebel_Child">
                                    <asp:Label ID="Label4" runat="server" Text="Designation Name Entry" ></asp:Label>
                                    </div></div>
                                <div class="testinfo">
                                    <table style="margin-left: 240px;">
                                        <tr>
                                ...
                                <div class="Singlelebel_Child">
                                    <asp:Label ID="Label8" runat="server" Text="Designation Name List" ></asp:Label></div>
                                <div>
                ...
                <ajaxtoolkit:TabPanel runat="Server" ID="TabPanel1" HeaderText="Role Info">
                    <ContentTemplate>
                        <asp:UpdatePanel runat="server" ID="UpdatePanel3">
                            ...
                            <div class="middle">
                            <div class="Singlelebel_Child">
                                <asp:Label ID="Label1" runat="server" Text="Employee Role Entry"></asp:Label>
                                </div>
                                </div>
                                <div
                                    class="EmpRoleSetup">
                                ...
                                <div class="Singlelebel_Child">
                                <asp:Label ID="Label10" runat="server" Text="Employee Role List" ></asp:Label>
                               </div> 
                                <div
                                    class="GridView">
                                    <table style="width: 100%;">
