<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="LogFileJouranlEditRpt.aspx.cs" Inherits="UI.AccSysManagment.LogFile.LogFileJouranlEditRpt" %>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="White"
                            ...
                            DataKeyNames="LogJournalId" OnPageIndexChanging="GridView1_PageIndexChanging"
                            PageSize="15">
