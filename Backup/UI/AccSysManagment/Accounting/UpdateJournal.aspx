<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="UpdateJournal.aspx.cs" Inherits="UI.AccSysManagment.Accounting.UpdateJournal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        function confApprove() {
            ...
            document.getElementById('TextBox1').value = resp;
        }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="PanelEntity" Visible="false" runat="server">
                <div>
                ...
                <div class="journal_main">
                    ...
                    <div class="journal_left">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label12" runat="server" CssClass="SingleLbl_journal" Text="DR Amount:"></asp:Label>
                                </td>
                                <td>
                    ...
                    <div class="journal_right">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTransectionDate" CssClass="textbox_Journal" runat="server" Text="Today"></asp:TextBox>
            ...
            <asp:Panel ID="PanleAdd" Visible="false" runat="server">
                <div>
            ...
            <div>
                <asp:GridView ID="GvJrEntry" runat="server" BackColor="White" BorderColor="White"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="JournalId" HeaderText="Journal_Id" />
                        <asp:BoundField DataField="JournalType" HeaderText="Type" />
            ...
            <asp:Panel ID="PnlAction" Visible="false" runat="server">
                <table style="width: 100%; margin-top: 15px;">
                    <tr>
                        <td>
                            <asp:Button ID="BtnSave" runat="server" Text="Post to Ledger" CssClass="SaveBtn"
            ...
            <asp:Panel ID="PanelGVShow" Visible="false" runat="server">
                <asp:Label ID="Label22" runat="server" CssClass="Font_header" Text="Select Journal to Edit OR  "></asp:Label>
                <asp:Button ID="BtnPostToLedger" runat="server" Text="Post To Ledger" OnClientClick="return confirm('Are you want to Post To Ledger?')"
                    OnClick="BtnPostToLedger_Click" Width="132px" />
                <table style="width: 100%;">
                    <tr>
                        <td style="margin-left: 4px;">
                            <asp:GridView ID="GvJrShow" runat="server" BackColor="#92B8EF" ForeColor="Snow" BorderColor="#92B8EF"
                                CssClass="textbox" BorderStyle="Ridge" BorderWidth="2px" Font-Size="11px" CellPadding="3"
                                CellSpacing="1" GridLines="None" AutoGenerateColumns="False" Height="15px" AllowPaging="True"
                                Width="100%" PageSize="6" DataKeyNames="JournalId" OnPageIndexChanging="GvJrShow_PageIndexChanging"
                                OnSelectedIndexChanged="GvJrShow_SelectedIndexChanged">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="TransectionNo" HeaderText="No#" />
                                    <asp:BoundField DataField="COAName_Num" HeaderText="Chart of Accounts" />
                                    <asp:BoundField DataField="SubCode2Name_Num" HeaderText="Accounts" />
                                    <asp:BoundField DataField="DRAmount" HeaderText="DRAmount" />
                                    <asp:BoundField DataField="CRAmount" HeaderText="CRAmount" />
                                    <asp:BoundField DataField="VONO" HeaderText="VONO#" />
                                    <asp:BoundField DataField="MRNO" HeaderText="MRNO#" />
                                    <asp:BoundField DataField="Remarks" HeaderText="Remarks" />
                                    <asp:BoundField DataField="COAId" HeaderText="COAId" />
                                </Columns>
                            </asp:GridView>
                        </td>
                    </tr>
                ...
                <table>
                    <tr>
                        <td style="width:700px;">
                            <asp:Label ID="Label19" runat="server" CssClass="Font_header" Text="Select Journal Post to Ledger"></asp:Label>
                            <asp:Button ID="btnRefreshJournal" runat="server" Text="Refresh Journal" OnClick="btnRefreshJournal_Click" />
                        </td>
                            ...
                            <asp:Repeater ID="RptJournalShow" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr style="background-color: #EEF5FF; text-align: center; font-size: 11px;">
                                        <td>
                                            <asp:LinkButton ID="btnShow" runat="server" OnCommand="LinkButton_Command" CommandArgument='<%# Eval("TransectionNo") %>'
                                                Text="[Show]" CommandName="Select" CausesValidation="false" />
                                        </td>
                                        <td>
        ...
        <%--    <Triggers>
        <asp:PostBackTrigger  ControlID="btnRefreshJournal" />
        </Triggers>--%>
    </asp:UpdatePanel>
</asp:Content>
