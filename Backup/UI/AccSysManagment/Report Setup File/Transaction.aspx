                        ...
                        <asp:Panel ID="PnlgvTransectDtl" runat="server">
                            ...
                            <asp:GridView ID="TransDetailsGrid" runat="server" BackColor="#92B8EF" ForeColor="Snow"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DRCOAIdNum" HeaderText="DR COA Id" />
                                    <asp:BoundField DataField="DrSubVocerCodeName" HeaderText="Dr Sub Vocer" />
                                    <asp:BoundField DataField="CRCOAIdNum" HeaderText="CR COAId Num" />
                                    <asp:BoundField DataField="CrSubVocerCodeName" HeaderText="Cr Sub Vocer" />
                                </Columns>
                            </asp:GridView>
                        </asp:Panel>
