...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel runat="server" ID="TimedPanel" UpdateMode="Conditional">
        <ContentTemplate>
            <ajaxtoolkit:TabContainer runat="server" ID="Tab" ActiveTabIndex="0" Width="100%">
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <asp:Image ID="Image1" Height="210px" Width="220px" BorderWidth="1px" runat="server"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lblImageMewssage" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                                            <br />
                                            <asp:Image ID="Image1" Height="200px" Width="210px" BorderWidth="1px" runat="server"
                                                ImageUrl="~/Images/Pic002.jpg" />
                                        </td>
                                    </tr>--%>
                                    <tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView ID="GvEmpBasic" runat="server" BackColor="White" BorderColor="White"
                                            ...
                                            OnPageIndexChanging="GvEmpBasic_PageIndexChanging" DataKeyNames="EmpId" PageSize="4">
