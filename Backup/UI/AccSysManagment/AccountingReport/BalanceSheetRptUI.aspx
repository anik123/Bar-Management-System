<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BalanceSheetRptUI.aspx.cs"
    Inherits="UI.AccSysManagment.AccountingReport.BalanceSheetRptUI" %>
...
<body>
    ...
    <div style="margin-left: 300px; margin-top: 10px;">
        <table>
            <tr>
                <td>
                    <asp:Label ID="Label3" runat="server" Font-Bold="true" Text="Balance Report..."></asp:Label>
    ...
    <div style="margin-left: 300px; margin-top: 10px;">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            <LocalReport ReportPath="AccSysManagment\AccountingReport\BalanceSheetRpt.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSet1" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="BalenceSheet"
