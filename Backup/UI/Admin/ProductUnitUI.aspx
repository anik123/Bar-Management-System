...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="up" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div>
                <asp:Label ID="Label5" runat="server" Text="Product Unit Entry" CssClass="Font_header"></asp:Label>
            </div>
            <div style="margin-bottom: 20px;">
                <table style="margin-left: 235px; margin-top: 20px;">
                    <tr>
                        <td>
                            <asp:Label ID="Label6" runat="server" CssClass="SingleLbl">Product Unit Name</asp:Label>
                        </td>
                        <td>
            ...
            <div>
                <asp:Label ID="Label2" runat="server" Text="Product Unit List" CssClass="Font_header"></asp:Label>
                <table style="width: 100%;">
                    <tr>
                        <td>
