<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="BranchReturnUI.aspx.cs" Inherits="UI.Shop.BranchReturnUI" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <asp:GridView ID="GvUpdate" runat="server" BackColor="#92B8EF" ForeColor="Snow" BorderColor="#92B8EF"
                    ...
                    <Columns>
                        <asp:BoundField DataField="ChangeDtlId" HeaderText="Change Id #" />
                        <asp:BoundField DataField="CreateDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Return Date" />
