                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rvcon" ValidationGroup="vg4" runat="server" ForeColor="Red" ControlToValidate="txtCustomerName">Name Req</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <asp:Panel ID="pnlUpdate" runat="server">
                <asp:Label ID="Label7" runat="server" CssClass="Font_header" Text="Product Entry"></asp:Label><asp:TextBox
                    ID="txtProductId" Width="80px" runat="server"></asp:TextBox><asp:Button ID="btnProduct"
                        runat="server" Text="Product Click" OnClick="btnProduct_Click" /><br>
                        ...
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RFv" runat="server" ValidationGroup="vg4" ForeColor="Red" ControlToValidate="ddlCName">Se555lect</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
