            ...
            <asp:Panel ID="PnlLoadRequsionDatalist" Visible="false" runat="server">
                <asp:Label ID="Label2" runat="server" CssClass="Font_header" Text="Requisition Product List"></asp:Label><span
                    style="padding-left: 20px;"><asp:Button ID="btnPost" runat="server" Width="122px"
                        CausesValidation="false" Height="22px" Text="Post To Order" OnClick="btnPost_Click" /></span>
                ...
                <div class="InvenPur_main">
                    ...
                    <div class="InvenPur_right">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label15" runat="server" CssClass="clabel_Tarun" Text="Sales Man"></asp:Label>
                                </td>
                                <td>
