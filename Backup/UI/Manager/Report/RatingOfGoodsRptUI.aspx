<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RatingOfGoodsRptUI.aspx.cs"
    Inherits="UI.Manager.Report.RatingOfGoodsRptUI" %>
        ...
        <ContentTemplate>
            <div style="margin-left: 340px; margin-top: 20px;">
                <table style="float: left;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlBranchName" runat="server" Width="120px">
                            </asp:DropDownList>
                        </td>
                        <td>
            ...
            <div style="margin-left: 330px; margin-top: 10px;">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="650px" Width="650px"
                    ...
                    <LocalReport ReportPath="Manager\Report\OperationSummary_Sales_Purchase_Rpt.rdlc">
                        <DataSources>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="OperationSummary"
                    TypeName="BLL.ReportBLL">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlCategory" Name="catid" Type="Int32" />
                    </SelectParameters>
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlBranchName" Name="brid" Type="Int32" />
                    </SelectParameters>
                    <SelectParameters>
