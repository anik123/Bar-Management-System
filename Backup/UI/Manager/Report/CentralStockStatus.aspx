<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CentralStockStatus.aspx.cs"
    Inherits="UI.Manager.Report.CentralStockStatus" %>
        ...
        <ContentTemplate>
            <div style="margin-left: 330px; margin-top: 0px;">
                <table style="float: left;">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCompany" runat="server" AutoPostBack="true" Width="130px">
                            </asp:DropDownList>
                        </td>
                        <td>
            ...
            <div style="margin-left: 330px; margin-top: 0px;">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                    ...
                    WaitMessageFont-Size="14pt" Width="620px">
                    <LocalReport ReportPath="Manager\Report\CentralStoreStatusRpt.rdlc">
                        <DataSources>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="CentralStoreStatus"
