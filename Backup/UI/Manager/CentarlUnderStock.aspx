<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CentarlUnderStock.aspx.cs" Inherits="UI.Manager.CentarlUnderStock" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlAction" runat="server">
                <asp:Label ID="Label8" runat="server" CssClass="Font_header" Text=" Central Under Stock Product List"></asp:Label>
                <asp:GridView ID="GvUpdate" runat="server" BackColor="#92B8EF" ForeColor="Snow" BorderColor="#92B8EF"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CenterReorderValue" HeaderText="Reorder Quantity #" />
                        ...
                        <asp:BoundField DataField="PurReqQuantity" HeaderText="Requisition Quantity #" />
                    </Columns>
                </asp:GridView>
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 400px;">
                            <asp:Button ID="btnRefresh" runat="server" CausesValidation="false" CssClass="SaveBtn"
                                Text="Refresh" OnClick="btnRefresh_Click" />
                        </td>
                        <td>
                            <asp:Button ID="btnCreateReqisisiton" runat="server" CssClass="btnCreateReqisition"
                                CausesValidation="false" Text="Create Purchases Requisition" OnClick="btnCreateReqisisiton_Click" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
