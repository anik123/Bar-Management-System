<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CentralAllChallenViewUI.aspx.cs" Inherits="UI.Manager.CentralAllChallenViewUI" %>
                    ...
                    <div class="PharmProPur_main">
                        ...
                        <div class="InvenPur_right">
                            <table style="width: 100%">
                                <tr>
                                    <td>
                                        <asp:Label ID="Label12" runat="server" CssClass="clabel_Location" Text="Branch : "></asp:Label>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlBranch" runat="server" CssClass="input_textcss" Width="204px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="Label13" runat="server" CssClass="clabel_Location" Text="Challan No#:"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtChallanNo" CssClass="input_textcss" Width="202px" runat="server"></asp:TextBox>
                                        <ajaxtoolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server" 
                                            TargetControlID="txtChallanNo" FilterType="Custom, Numbers" ValidChars="" Enabled="True" />
                                    </td>
                                </tr>
                            </table>
                        </div>
            ...
            <asp:Panel ID="pnlRec" runat="server">
                <div class="PharmProPur">
                    ...
                    <asp:GridView ID="GVCOA" runat="server" BackColor="#92B8EF" ForeColor="Snow" BorderColor="#92B8EF"
                        ...
                        PageSize="15" DataKeyNames="ChallanId" OnPageIndexChanging="GVCOA_PageIndexChanging"
                        ...
                        <Columns>
                            <asp:BoundField DataField="ChallanId" HeaderText="Challan No#" />
                            <asp:BoundField DataField="BrProName" HeaderText=" To Branch" />
                            <asp:BoundField DataField="ChallanDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Challan Date" />
                            <asp:BoundField DataField="ChallanBy" HeaderText="Challan By" />
