    ...
    public partial class BranchChallanUI : System.Web.UI.Page
    {
        ...
        protected void btnPost_Click(object sender, EventArgs e)
        {
            ...
            for (int j = 0; j < dt1.Rows.Count; j++)
            {
                ...
                if (Quantity.Count != 0)
                {
                    int? quantity = Quantity.First().QuantityStore;
        ...
        {
            var data = ChalBLL.LoadBranchReqisitonNo(Convert.ToInt32(GVPur.Rows[0].Cells[9].Text));
            int? BrproId = data.First().BrProId;
            ChalInfoDTO.ChallanBy = "tarun";
            ...
            var challanid = ChalBLL.LoadInvenCentralChallanID();
            int ChallanId = challanid.First().ChallanId;
            ...
            foreach (GridViewRow row in GVPur.Rows)
            {
                ...
                ChalDtlDTO.ChallanId = ChallanId;
