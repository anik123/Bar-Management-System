<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PurchasePaymentDueUI.aspx.cs" Inherits="UI.Manager.PurchasePaymentDueUI" %>
                    ...
                    <div class="PharmPur_Payment_left">
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtDateFrom" CssClass="input_textcss" Width="202px" runat="server"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtDateTo" CssClass="input_textcss" Width="202px" OnTextChanged="txtSearch"
                    ...
                    <div class="PharmPur_Payment_right">
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtOrderNO" CssClass="input_textcss" Width="202px" runat="server"
                                        OnTextChanged="txtSearch"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="fg" InitialValue="0" runat="server" CssClass="RequiredFieldcss"
                                        ErrorMessage="Category Re" ControlToValidate="txtOrderNO"></asp:RequiredFieldValidator>
                                    <ajaxtoolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                        TargetControlID="txtOrderNO" FilterType="Custom, Numbers" ValidChars=""
                                        Enabled="True" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlCompanyName" runat="server" Width="202px" AutoPostBack="true"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSalesManName" runat="server" OnTextChanged="txtSearch" AutoPostBack="true"
                                        CssClass="input_textcss" Width="200px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GvDueInfo" runat="server" BackColor="White" BorderColor="White"
                                    Width="100%" Font-Size="11px" BorderStyle="Ridge" CellPadding="3" CellSpacing="1"
                                    GridLines="None" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="GvDueInfo_PageIndexChanging"
                                    DataKeyNames="PurId" PageSize="5" OnSelectedIndexChanged="GvDueInfo_SelectedIndexChanged">
                                    ...
                                    <Columns>
                                        <asp:CommandField HeaderText="Payment" ShowHeader="True" SelectText="Click Pay" ControlStyle-ForeColor="Red"
                                            ShowSelectButton="True">
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:CommandField>
                                        <asp:BoundField DataField="PurId" HeaderText="Purchase NO#" />
                                        <asp:BoundField DataField="PurOrderNo" HeaderText="Order NO#" />
                                        <asp:BoundField DataField="PaymentDate" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Last Pay Date" />
                ...
                <div class="Salpayment_Right">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPaidAmoun" OnTextChanged="txtPaidAmoun_TextChanged" Width="140px"
                                    CssClass="input_textcss" runat="server"></asp:TextBox><span class="Mandatory"> *</span>
                                <ajaxtoolkit:FilteredTextBoxExtender ID="ft" runat="server" TargetControlID="txtPaidAmoun"
